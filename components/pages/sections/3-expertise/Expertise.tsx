...
const Icon = () => <svg width="60" height="60" viewBox="0 0 60 60" fill="none" className='pr-px size-12 lg:size-16 stroke-gray-400 xs:pr-1' xmlns="http://www.w3.org/2000/svg">
