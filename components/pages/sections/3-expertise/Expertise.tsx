...
const EmptyCard = () => {
    return <>
        <div className={twMerge(
            'h-full w-full col-span-1 row-span-1', 'opacity-60 relative', BORDER_CARD_CLASS_NAME)}>
            <span></span>
        </div>
    </>
}
