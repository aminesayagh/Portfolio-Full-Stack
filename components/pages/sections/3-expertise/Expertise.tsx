...
const Icon = () => <svg width="60" height="60" viewBox="0 0 60 60" fill="none" className='w-12 h-12 pr-px lg:w-16 lg:h-16 stroke-gray-400 xs:pr-1' xmlns="http://www.w3.org/2000/svg">
