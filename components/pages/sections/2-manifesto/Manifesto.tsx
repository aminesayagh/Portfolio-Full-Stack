            ...
            <div className={twMerge(LINE_CLASSNAME)} >
                ...
                <div className={twMerge('flex flex-col gap-4')} >
                    ...
                    <div className={twMerge('')} >
                        <Title h1 weight='bold' degree='1'>{t('manifesto.title_1')}</Title>
                    </div>
                    <div className={twMerge('flex flex-row gap-3')} >
                        <Text p size='md' weight='semibold' degree='3'>{t('manifesto.slogan')}</Text>
                        <div className='rounded-lg'>
                            <Image src='' width={400} height={120} alt={t('manifesto.image_alt')} />
                        </div>
                        <Title h1 weight='bold' degree='1'>{t('manifesto.title_2')}</Title>
                    </div>
                    <div className={twMerge('w-full')} >
                        <hr className={twMerge('border-gray-300')} />
                    </div>
                </div>
            </div>
        </>
        ...
        <>
            <div className={twMerge(LINE_CLASSNAME)} >
                <div>
                    ...
                    <Title h3 weight='bold' degree='3'>{t('manifesto.content')}</Title>
                </div>
            </div>
        </>
    )
